...
static void mavlink_test_rpm(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_rpm_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	...
        	packet1.rpm7 = packet_in.rpm7;
        	packet1.rpm8 = packet_in.rpm8;
	...
	mavlink_msg_rpm_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_rpm_pack(system_id, component_id, &msg , packet1.rpm1 , packet1.rpm2 , packet1.rpm3 , packet1.rpm4 , packet1.rpm5 , packet1.rpm6 , packet1.rpm7 , packet1.rpm8 );
	mavlink_msg_rpm_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_rpm_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.rpm1 , packet1.rpm2 , packet1.rpm3 , packet1.rpm4 , packet1.rpm5 , packet1.rpm6 , packet1.rpm7 , packet1.rpm8 );
	mavlink_msg_rpm_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_rpm_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_rpm_send(MAVLINK_COMM_1 , packet1.rpm1 , packet1.rpm2 , packet1.rpm3 , packet1.rpm4 , packet1.rpm5 , packet1.rpm6 , packet1.rpm7 , packet1.rpm8 );
	mavlink_msg_rpm_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_airborne_rpm(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_airborne_rpm_t packet_in = {
		{ 17235, 17236, 17237, 17238, 17239, 17240, 17241, 17242 }
    };
	mavlink_airborne_rpm_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        
        	mav_array_memcpy(packet1.RPM, packet_in.RPM, sizeof(uint16_t)*8);
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_airborne_rpm_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_airborne_rpm_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_airborne_rpm_pack(system_id, component_id, &msg , packet1.RPM );
	mavlink_msg_airborne_rpm_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_airborne_rpm_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.RPM );
	mavlink_msg_airborne_rpm_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_airborne_rpm_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_airborne_rpm_send(MAVLINK_COMM_1 , packet1.RPM );
	mavlink_msg_airborne_rpm_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_ardupilotmega(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_airborne_rpm(system_id, component_id, last_msg);
}
